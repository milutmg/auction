      ...
      <div className="w-full max-w-md">
        <GlassmorphicCard variant="default" shadow="md" className="p-8">
          ...
          <div className="mb-8 text-center">
            <div className="mx-auto w-12 h-12 bg-gradient-to-r from-gold/20 to-gold/10 rounded-full flex items-center justify-center mb-4">
            ...
            {location.state?.message && (
              <p className="text-sm text-gold mt-2 bg-gold/10 rounded-md p-2">
                {location.state.message}
              </p>
            )}
          </div>
